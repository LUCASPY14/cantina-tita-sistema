...
def planes_almuerzo_view(request):
    ...
    return render(request, 'lunch/plans/list.html', context)
...
def menu_diario_view(request):
    ...
    return render(request, 'lunch/menu/daily.html', context)
...
def facturacion_mensual_almuerzos_view(request):
    ...
    return render(request, 'reports/billing/mensual_almuerzos.html', context)
