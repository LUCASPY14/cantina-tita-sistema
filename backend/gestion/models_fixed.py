...
class NotasCreditoProveedor(models.Model):
    ...
    # id_compra_original = models.ForeignKey(  # COMENTADO: Modelo CompraProveedor no existe
            Compras,
            on_delete=models.SET_NULL,
...
class AplicacionPagosVentas(models.Model):
    ...
    # id_pago_venta = models.ForeignKey(  # COMENTADO: Modelo Venta no existe en gestion
    #     PagosVenta,
            on_delete=models.CASCADE,
...
class NotasCreditoCliente(models.Model):
    ...
    id_venta_original = models.ForeignKey(  # COMENTADO: Modelo Venta no existe en gestion
        'gestion.Ventas',  # CAMBIADO: Referencia por string
        on_delete=models.SET_NULL,
